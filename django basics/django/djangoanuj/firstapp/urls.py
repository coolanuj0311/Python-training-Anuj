...
urlpatterns=[
    ...
    path('myimagepage',views.myimagepage,name='myyimageapp'),
    path('myimagepage2',views.myimagepage2,name='myimagepage2'),
    path('myimagepage3',views.myimagepage3,name='myyimageapp3'),
    path('myimagepage4',views.myimagepage4,name='myimagepage4'),
    path('myimagepage5',views.myimagepage5,name='myimagepage5')
